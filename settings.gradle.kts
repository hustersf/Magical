...
include(":packages:ai-edge-compose")
...
include(":core:ui")
include(":core:res:view")
include(":core:res:icon")
include(":core:common")
include(":core:media")
include(":core:speech")
...
include(":core:ai-edge:design-compose")
include(":core:ai-edge:navigation")
...
include(":feature:ai-edge:explore:impl-compose")
