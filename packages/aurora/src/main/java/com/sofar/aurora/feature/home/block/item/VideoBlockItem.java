...
import com.sofar.aurora.feature.home.block.binder.VideoBlockViewBinder;
import com.sofar.base.viewbinder.RecyclerViewBinder;

public class VideoBlockItem extends BlockItem {

  @Override
  public View createView(ViewGroup parent) {
    return LayoutInflater.from(parent.getContext()).inflate(R.layout.block_item_video, parent, false);
  }

  @Override
  public RecyclerViewBinder createViewBinder() {
    RecyclerViewBinder viewBinder = new RecyclerViewBinder();
    viewBinder.addViewBinder(new VideoBlockViewBinder());
